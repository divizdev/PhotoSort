...
//
//
//                    gpsData = gpsName.getGeoName(connection, geoLocation.getLatitude(), geoLocation.getLongitude());
//                    }
//                }
...
//                dbPhotoInfo.insertDBPhotoInfo(connection, photoInfo);
...
//        }
        ...
        convertGeoName.LoadFileToDB("allCountries.txt");


        ConvertAlterName convertAlterName = new ConvertAlterName();
        convertAlterName.LoadFileToDB("alternateNames.txt");
        long finish = System.nanoTime();
        System.out.println("Full time: " + (finish - start));
    }
}
